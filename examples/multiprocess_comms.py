"""
Demo to show how to use Pyside6 and qt signals in combination with threads and
processes.
...
from PySide6.QtWidgets import QApplication, QLineEdit, QTextBrowser, QVBoxLayout, QDialog
